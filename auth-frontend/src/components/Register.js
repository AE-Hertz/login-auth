    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(
                "https://login-auth-f8vb.onrender.com/api/auth/register",
                { username, password }
            );
                ...
                <div className="w-full h-full bg-white flex flex-col p-20 justify-between">
                    ...
                    <div className="w-full flex flex-col max-w-[550px]">
                        <div className="w-full flex flex-col mb-2">
                            ...
                            <p className="text-sm mb-2">Welcome, new user</p>
                        </div>
                        <form
                        ...
                        >
                            ...
                            <div className="w-full flex items-center justify-between">
                                <div className="w-full flex flex-col my-4">
                                    <button
                                        className="w-full text-white my-2 bg-black  font-semibold border-black rounded-md p-4 text-center flex items-center justify-center"
                                        type="submit"
                                    >
                                        Register
                                    </button>
                    ...
                    <div className="w-full items-center flex justify-center max-w-[550px]">
